    ...
    <Card color="violet">
      ...
      {isEllie ? (
        <>
          <Card.Content>
            <Card.Description>
              사랑스러운 두 아이의 엄마이자 뒤늦게 배운 코딩이 제일 재미있는
              백엔드 개발자 최윤성입니다. 클린한끼 팀에서는 데이터 분석과
              백엔드를 맡았습니다. CS, 알고리즘 등 기본기가 튼튼한 개발자, 제
              딸들이 살아갈 세상이 더 편리해지고, 지속할 수 있는 성장을 할 수
              있도록 이바지하는 개발자가 되고 싶어요. 미래에는 미국 실리콘밸리로
              가서 아이들에게 무한한 가능성을 보여줄 거예요.
            </Card.Description>
          </Card.Content>
          <Card.Content extra>
