        ...
        <Card color="green" >
            ...
            {isNoelle ? (
                <>
                    <Card.Content>
                        <Card.Description>
                        위생이라는 주제와 '클린한끼'라는 타이틀을 제안했으며, 프론트엔드와 디자인을 담당했던 웹 개발자 고예림입니다. 웹 프로젝트를 진행하면서 CSS 기능이 많을 시, 서로의 속성을 충돌해 제대로 기능하지 못한다는 것을 알게되면서 CSS는 최소한으로만 구현해야한다는 것을 배웠습니다. 사용자에게 편리한 웹 사이트를 구현하기 위해, 알고리즘과 CSS기초에 힘쓰는 개발자가 될 것입니다.
                        </Card.Description>
                        </Card.Content>
                        <Card.Content extra>
