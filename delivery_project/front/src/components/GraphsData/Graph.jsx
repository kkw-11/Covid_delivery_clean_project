        ...
        <>
          ...
          >
            <ReactApexChart
              options={{
                ...
                labels: ["위생가게 중 프랜차이즈", "위생가게 중 일반음식점"],
                theme: {
                  palette: "palette2",
                },
                plotOptions: {
              ...
              series={[
                franchise.data["all"][area] - franchise.data["franchise"][area],
                franchise.data["franchise"][area],
              ]}
              type="donut"
              width="85%"
            />
          ...
          >
            <ReactApexChart
              ...
              series={[
                franchise.data["all"][area],
                allfranchise.data[area] - franchise.data["all"][area],
              ]}
              type="donut"
              width="85%"
            />
