    ...
    <>
        ...
        <svg height= { 650 } width= { 735 } margin= { 100 }>
            ...
            <path 
                ...
                fill={fillColor[colorSpectrum(color["종로구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["중구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["용산구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["성동구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["광진구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["동대문구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["중랑구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)}
                fill={fillColor[colorSpectrum(color["성북구"])]} 
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["강북구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["도봉구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["노원구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["은평구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["서대문구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["마포구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["양천구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["강서구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["구로구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["금천구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["영등포구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["동작구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["관악구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["서초구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["강남구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["송파구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color["강동구"])]}
