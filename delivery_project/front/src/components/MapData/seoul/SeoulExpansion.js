...
const SeoulExpansion = ({color, onAreaClick}) => {
    ...
    <>
        ...
        <svg height= { 650 } width= { 735 } margin= { 100 } style={{position:'absolute', display:'flex'}}>
            ...
            <path 
                ...
                fill={fillColor[colorSpectrum(color['all']["종로구"])]} 
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["성동구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["광진구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["동대문구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["중랑구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)}
                fill={fillColor[colorSpectrum(color['all']["성북구"])]} 
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["강북구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["도봉구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["노원구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["은평구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["서대문구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["마포구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["양천구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["강서구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["구로구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["금천구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["영등포구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["동작구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["관악구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["서초구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["강남구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["송파구"])]}
            ...
            <path 
                ...
                className="OUTLINE" 
                onClick={(e)=>onAreaClick(e.target.id)} 
                fill={fillColor[colorSpectrum(color['all']["강동구"])]}
