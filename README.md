...
- 기술 이외 배운점
  ...
  - 프로젝트 기간동안 매일 아침에 스크럼을 진행하며 커뮤니케이션을 하는 법에 대해서도 배울 수 있었습니다. 기획단계에서는 왜 이러한 기획이 있어야하는지 설득했습니다. 그러면서 내가 알고 있는 것을 어떻게 상대가 이해할 수 있게 효율적으로 전달하는지 고민하고 전달해야하는지 배웠습니다. 프로젝트 진행기간에는 프론트엔드 팀과 백엔드 팀이 데이터를 주고 받는 과정의 코드를 작성할 때도 api로 소통하는 법을 배웠습니다.
