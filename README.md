...
* [ ] 지역별 위생등급별 가게수 확인 기능
* [ ] 위생가게 수에 따른 지도 색표시 기능
* [ ] 위생가게 수치를 절대값, 상대값 전환 기능
* [ ] 프로젝트 소개 페이지 그래프 시각화기능
  * [ ] 코로나 전후 배달대행 건수 비교 막대 그래프 
  * [ ] 배달음식 민원 비율 그래프
  * [ ] 코로나 이후 위생 상태 불량 적발 건수 증가 그래프
* [ ] 위생가게 정보 검색 기능
  * [ ] 가게이름별 검색
  * [ ] 지역별 검색
  * [ ] 업태(ex.한식, 중식, 양식, 카페,디저트)별 검색
  * [ ] 사용자 위치 기반으로 가까운 가게 우선순위로 데이터 리스트 출력 기능
  * [ ] 프랜차이즈를 제외한 일반가게만 보기 기능
