...
- 보완할 점
  - 3주라는 짧은 기간동안 원하는 많은 기능을 넣기 위해 기능동작이라는 목표는 달성하였으나 코드의 가독성과, 확장성을 생각하지 못하고 개발하였습니다. 추후에는 단순히 동작만 하는 코드가 아니라확장성 있는 코드를 위해 레거시 코드를 리팩토링하는 작업과 추가기능을 더 보완할 생각입니다.
